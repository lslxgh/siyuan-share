        ...
        this.container.innerHTML = `
            <div class="fn__flex-column" style="height: 100%; padding: 16px;">
                <div class="fn__flex" style="align-items: center; margin-bottom: 16px; gap: 8px;">
                    <h3 style="margin: 0; flex: 1;">${this.plugin.i18n.shareListTitle || "全部分享"}</h3>
                ...
                <div class="share-list__loading" id="shareListLoading" style="display: none; text-align: center; padding: 40px;">
                    ...
                    <div class="b3-label__text" style="margin-top: 16px;">${this.plugin.i18n.shareListLoading || "加载中..."}</div>
                </div>
                ...
                <div class="share-list__empty" id="shareListEmpty" style="display: none; text-align: center; padding: 40px; color: var(--b3-theme-on-surface-light);">
                    ...
                    <div class="b3-label__text" style="margin-top: 16px;">${this.plugin.i18n.shareListEmpty || "暂无分享记录"}</div>
                </div>
            ...
            <div class="fn__flex" style="align-items: flex-start;">
                <div class="fn__flex-1" style="min-width: 0;">
                    ...
                    <div class="fn__flex" style="gap: 16px; flex-wrap: wrap; color: var(--b3-theme-on-surface-light); font-size: 12px;">
                        ...
                        <span>
                            ${this.plugin.i18n.shareListViewCount || "访问"}: ${record.viewCount || 0}
                        </span>
                        <span>
                            ${this.plugin.i18n.shareListAccessLabel || "权限"}: ${accessText}
                        </span>
                        <span>
                            ${this.plugin.i18n.shareListCreatedAt || "创建"}: ${createdDate}
                        </span>
                        <span>
                            ${this.plugin.i18n.shareListExpireAt || "到期"}: ${expireDate}
                        </span>
                    </div>
                </div>
                <div class="fn__flex" style="gap: 8px; margin-left: 16px;">
                    <button class="b3-button b3-button--outline" data-action="open" data-doc-id="${record.docId}" title="${this.plugin.i18n.shareListOpenDoc || "打开文档"}">
                        <svg class="b3-button__icon"><use xlink:href="#iconFile"></use></svg>
                    </button>
                    <button class="b3-button b3-button--outline" data-action="copy" data-url="${this.escapeHtml(record.shareUrl)}" title="${this.plugin.i18n.copyLink || "复制链接"}">
                        <svg class="b3-button__icon"><use xlink:href="#iconCopy"></use></svg>
                    </button>
                    <button class="b3-button b3-button--outline" data-action="delete" data-id="${record.id}" title="${this.plugin.i18n.shareListDelete || "删除"}">
